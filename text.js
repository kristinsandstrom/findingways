...
// array with text to type
  var dataText = [ "Riding ASTRIDE was considered until the end of 19th century as incorrect for women because it can be seen as a metaphor of sexual contact."];
  //text input caret
  var caret = "\u258B";
